...
export async function GET() {
  const staticRoutes = [
    ...
    { url: `${baseUrl}/popular`, priority: '0.9', changefreq: 'daily' },
    { url: `${baseUrl}/categories`, priority: '0.9', changefreq: 'weekly' },
    { url: `${baseUrl}/playlists`, priority: '0.9', changefreq: 'daily' },
    { url: `${baseUrl}/leaderboard`, priority: '0.8', changefreq: 'daily' },
    { url: `${baseUrl}/tournaments`, priority: '0.8', changefreq: 'daily' },
    { url: `${baseUrl}/quests`, priority: '0.8', changefreq: 'daily' },
    { url: `${baseUrl}/achievements`, priority: '0.8', changefreq: 'weekly' },
    ...
    { url: `${baseUrl}/cookies`, priority: '0.4', changefreq: 'yearly' },
