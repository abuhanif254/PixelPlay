  ...
  return (
    <div className="container mx-auto px-4 lg:px-8 max-w-[1600px]">
      ...
      <div className="flex items-center space-x-2 text-[13px] text-gray-400 mb-6 font-medium">
        ...
        <span>&gt;</span>
        <span className="text-gray-200">Popular Games</span>
      </div>
      ...
      <div className="flex flex-col xl:flex-row gap-6">
        ...
        <div className="w-full xl:w-[260px] flex-shrink-0 flex flex-col gap-4">
          ...
          {/* Filters Block */}
          <div className="bg-[#111221] rounded-xl border border-white/5 p-5">
            <h3 className="text-white font-bold text-[15px] mb-4">Filters</h3>
            
            {/* Sort By Dropdown inside Filters */}
            <div className="mb-5">
              <h4 className="text-[13px] text-gray-300 mb-2">Sort By</h4>
              <select 
                value={sortBy}
                onChange={(e) => setFilter('sort', e.target.value)}
                className="w-full bg-[#1A1B2E] border border-white/5 text-gray-200 text-[13px] rounded-lg px-3 py-2 focus:outline-none focus:border-purple-500 cursor-pointer"
              >
            ...
            {/* Time Dropdown */}
            <div className="mb-5">
              <h4 className="text-[13px] text-gray-300 mb-2">Time</h4>
              <select 
              ...
              <div className="space-y-1.5">
                {[5, 4, 3].map(r => (
                  <label key={r} className="flex items-center gap-3 cursor-pointer group">
                    <div className="w-4 h-4 rounded border border-white/20 bg-[#1A1B2E] flex items-center justify-center group-hover:border-purple-500"></div>
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          {/* Hero Banner */}
          <div className="bg-gradient-to-r from-[#140F2D] via-[#100D28] to-[#0D1022] rounded-2xl border border-purple-500/20 p-6 lg:p-8 relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between">
              <div className="max-w-xl">
                <div className="flex items-center gap-3 mb-3">
                  <h1 className="text-3xl lg:text-4xl font-extrabold text-white tracking-tight">Popular Games <span className="text-3xl">🔥</span></h1>
                </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-8 relative z-10">
              <div className="bg-[#111221]/80 backdrop-blur border border-white/5 rounded-xl p-3 flex items-center gap-3">
                ...
                <div>
                  <div className="text-white font-bold text-lg leading-tight">{totalPlaysStr}</div>
                  <div className="text-gray-400 text-[11px]">Total Plays</div>
                </div>
              </div>
              <div className="bg-[#111221]/80 backdrop-blur border border-white/5 rounded-xl p-3 flex items-center gap-3">
                ...
                <div>
                  <div className="text-white font-bold text-lg leading-tight">{avgRating}</div>
                  <div className="text-gray-400 text-[11px]">Average Rating</div>
                </div>
              </div>
              <div className="bg-[#111221]/80 backdrop-blur border border-white/5 rounded-xl p-3 flex items-center gap-3">
                ...
                <div>
                  <div className="text-white font-bold text-lg leading-tight">{totalLikesStr}</div>
                  <div className="text-gray-400 text-[11px]">Likes</div>
                </div>
              </div>
              <div className="bg-[#111221]/80 backdrop-blur border border-white/5 rounded-xl p-3 flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-gray-400 text-[11px]">Most Popular</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center gap-4 ml-auto">
              ...
              <div className="flex items-center gap-2">
                ...
                <select 
                  value={sortBy}
                  onChange={(e) => setFilter('sort', e.target.value)}
                  className="bg-[#111221] border border-white/5 text-gray-200 text-[13px] rounded-lg px-3 py-1.5 focus:outline-none focus:border-purple-500 cursor-pointer"
                >
                  <option>Most Popular</option>
                  <option>Newest First</option>
                  <option>Highest Rated</option>
          ...
          {paginatedGames.length === 0 ? (
            <div className="bg-[#111221] rounded-2xl border border-white/5 p-12 text-center">
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-center space-x-2 mt-6">
              <button 
                ...
                className="w-9 h-9 rounded-lg bg-[#111221] border border-white/5 text-gray-400 flex items-center justify-center transition-all hover:bg-white/10 disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              {Array.from({ length: totalPages }).map((_, idx) => {
                ...
                return (
                  <button 
                    ...
                    className={`w-9 h-9 rounded-lg text-sm font-bold flex items-center justify-center transition-all border border-white/5 ${
                      page === currentPage 
                        ? 'bg-purple-600 text-white' 
                        : 'bg-[#111221] text-gray-400 hover:bg-white/10'
                    }`}
                  >
                    {page}
                  </button>
        ...
        <div className="w-full xl:w-[280px] flex-shrink-0 flex flex-col gap-6">
              ...
              {trendingThisWeek.length > 0 ? (
                trendingThisWeek.map((game, i) => (
                  <Link href={`/games/${game.slug || game.id}`} key={game.id} className="flex items-center gap-3 group cursor-pointer block">
                    ...
                    <div className="w-12 h-12 rounded-lg overflow-hidden relative flex-shrink-0 bg-[#05050F]">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between mt-0.5">
                        ...
                        <div className="flex items-center text-[#F59E0B] gap-0.5">
                          ...
                          <span className="text-[11px] font-bold text-gray-300">{game.rating || '5.0'}</span>
                        </div>
                      </div>
                    </div>
                  </Link>
          ...
          {/* Top Rated Games */}
          <div className="bg-[#111221] rounded-xl border border-white/5 p-5">
            <h3 className="text-white font-bold text-[15px] mb-4">Top Rated Games</h3>
            
            <div className="space-y-4">
              {topRated.map((game, i) => {
                return (
                  <Link href={`/games/${game.slug || game.id}`} key={game.id} className="flex items-center gap-3 group cursor-pointer block">
                    <div className="w-10 h-10 rounded-lg overflow-hidden relative flex-shrink-0 bg-[#05050F]">
            ...
            <button 
              ...
              className="w-full mt-5 bg-white/5 hover:bg-white/10 border border-white/10 text-purple-400 font-semibold text-[12px] py-2 rounded-lg transition-colors"
            >
          ...
          {/* Newsletter Box */}
          <div className="bg-[#140C24] rounded-xl border border-purple-500/20 p-5 relative overflow-hidden">
            <div className="relative z-10 flex flex-col">
              <h3 className="text-white font-bold text-[14px] mb-2 flex items-center justify-between">
              ...
              <input 
                ...
                className="w-full bg-black/40 border border-white/10 rounded-lg px-3 py-2 text-[12px] text-white focus:outline-none focus:border-purple-500 mb-2"
              />
      ...
      <div className="mt-12 bg-[#111221] border border-white/5 rounded-2xl p-6 lg:p-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-4 divide-y sm:divide-y-0 sm:divide-x divide-white/5">
          ...
          <div className="flex items-center gap-4 sm:px-4 first:pl-0">
            ...
            <div>
              <h4 className="text-gray-200 font-bold text-[14px]">Community Favorites</h4>
          ...
          <div className="flex items-center gap-4 pt-6 sm:pt-0 sm:px-4">
            ...
            <div>
              <h4 className="text-gray-200 font-bold text-[14px]">High Quality</h4>
          ...
          <div className="flex items-center gap-4 pt-6 sm:pt-0 sm:px-4">
            ...
            <div>
              <h4 className="text-gray-200 font-bold text-[14px]">Regular Updates</h4>
