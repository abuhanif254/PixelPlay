  ...
  return (
    <div className="mb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        {/* Main Large Article */}
        <div className="lg:col-span-8 flex flex-col bg-white dark:bg-[#111228] border border-gray-200 dark:border-white/5 rounded-2xl overflow-hidden hover:border-gray-300 dark:hover:border-white/10 transition-colors group relative shadow-sm dark:shadow-none">
            ...
            <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-200 dark:border-white/5">
              <div className="flex items-center gap-3 text-xs text-gray-500 font-medium">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">{mainArticle.author}</span>
                </div>
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
          {secondaryArticles.map((article, i) => (
            <div key={i} className="flex-1 bg-white dark:bg-[#111228] border border-gray-200 dark:border-white/5 rounded-2xl overflow-hidden hover:border-gray-300 dark:hover:border-white/10 transition-colors group flex flex-col shadow-sm dark:shadow-none">
              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-auto leading-tight group-hover:text-[#6366F1] transition-colors">
                  {article.title}
                </h3>
