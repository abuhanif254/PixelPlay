...
export default function LeaderboardFilters() {
  return (
    <div className="bg-transparent border border-white/5 rounded-2xl p-6 shadow-xl mb-6">
      <h3 className="text-xl font-bold font-outfit text-white mb-6">Filters</h3>
      
      <div className="flex flex-col gap-5">
        
        {/* Game Filter */}
        <div className="flex flex-col gap-2">
          <label className="text-xs font-bold text-gray-400">Game</label>
          <div className="relative">
            <div className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500">
              <Gamepad2 size={16} />
            </div>
            <select className="w-full bg-[#111228] border border-white/10 text-white text-sm rounded-xl pl-10 pr-4 py-3 appearance-none focus:outline-none focus:border-[#6366F1] cursor-pointer">
        ...
        {/* Region Filter */}
        <div className="flex flex-col gap-2">
          <label className="text-xs font-bold text-gray-400">Region</label>
          <div className="relative">
            <div className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500">
              <Globe2 size={16} />
            </div>
