...
export default function TopChampionCard() {
  return (
    <div className="bg-white dark:bg-[#111228] border border-gray-200 dark:border-white/5 rounded-2xl p-6 shadow-xl mb-6 relative overflow-hidden flex flex-col items-center text-center">
      ...
      <h3 className="font-bold text-xl text-gray-900 dark:text-white mb-1 z-10">AlexGamer</h3>
