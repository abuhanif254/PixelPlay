...
export default function TopThreePodium() {
  const topPlayers = [
    ...
    },
    {
      ...
      theme: {
        bg: 'bg-gradient-to-b from-[#78350F] to-[#451A03]',
    ...
    },
    {
      ...
      theme: {
        bg: 'bg-gradient-to-b from-[#451A03] to-[#2E1005]', // Using a bronze-ish tone
      ...
      {topPlayers.map((player) => (
        ...
        >
          ...
          <div className="relative mb-4">
            ...
            <div className={`w-20 h-20 rounded-full border-4 ${player.theme.border} overflow-hidden bg-white/10 p-1 relative z-10 shadow-inner`}>
          ...
          <h3 className={`font-bold text-white mb-1 ${player.rank === 1 ? 'text-xl' : 'text-lg'}`}>
            {player.name}
          </h3>
          ...
          <div className="flex items-center gap-1.5 mb-2">
            ...
            <span className={`font-black ${player.rank === 1 ? 'text-xl text-yellow-400' : 'text-lg text-white'}`}>
              {player.score}
            </span>
          </div>
