  ...
  return (
    <div className="bg-white dark:bg-transparent border border-gray-200 dark:border-white/5 rounded-2xl p-6 shadow-xl mb-6">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <div className="text-3xl font-black font-outfit text-gray-900 dark:text-white leading-none tracking-tight">128</div>
        </div>
      </div>
      ...
      <div className="flex gap-4 p-3 bg-gray-50 dark:bg-white/5 rounded-xl">
        ...
        <div className="flex flex-col justify-center">
          <span className="font-bold text-gray-900 dark:text-white text-sm mb-0.5">You</span>
      ...
      <Link href="#" className="flex items-center justify-center w-full py-3 mt-4 bg-transparent border border-gray-200 dark:border-white/10 hover:border-[#6366F1] hover:bg-[#6366F1]/10 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm font-bold rounded-xl transition-all">
        View Your Profile
      </Link>
    </div>
  );
