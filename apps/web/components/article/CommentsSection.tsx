  ...
  return (
    <div className="flex flex-col mt-4">
      ...
      <div className="flex items-center justify-between mb-8">
        <h3 className="text-xl font-bold font-outfit text-white">Comments (12)</h3>
        <div className="flex items-center gap-2">
          <span className="text-sm text-gray-400">Sort by:</span>
          <select className="bg-[#111228] border border-white/10 text-white text-sm rounded-lg px-3 py-1.5 focus:outline-none focus:border-[#6366F1] cursor-pointer">
      ...
      <div className="flex gap-4 mb-10">
        ...
        <div className="flex-1">
          <input 
            ...
            className="w-full bg-transparent border-b border-white/10 text-white text-sm px-0 py-2 focus:outline-none focus:border-[#6366F1] transition-colors placeholder:text-gray-500"
            value={comment}
      ...
      <div className="flex gap-4">
        ...
        <div className="flex flex-col flex-1">
          <div className="flex items-center gap-3 mb-1">
            <span className="text-white font-bold text-sm">GamerX</span>
