...
export default function InThisArticle() {
  ...
  return (
    <div className="bg-[#111228] border border-white/5 rounded-2xl p-6 md:p-8 mb-10 shadow-xl">
      <div className="flex items-center gap-3 mb-6">
        <AlignLeft className="text-[#6366F1]" size={20} />
        <h3 className="text-lg font-bold font-outfit text-white">In This Article</h3>
      </div>
