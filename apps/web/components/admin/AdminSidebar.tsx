...
export default function AdminSidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-64 bg-white dark:bg-[#0A0B1A]/95 backdrop-blur-xl border-r border-gray-200 dark:border-white/5 flex flex-col z-50">
      ...
      {/* Brand */}
      <div className="h-20 flex items-center px-6 border-b border-gray-200 dark:border-white/5 shrink-0">
        <Link href="/admin" className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#6366F1] to-purple-600 flex items-center justify-center text-white shrink-0">
      ...
      <div className="p-4 border-t border-gray-200 dark:border-white/5 flex flex-col gap-1 shrink-0">
        ...
        {/* Admin info card */}
        {adminProfile && (
          <div className="flex items-center gap-3 px-3 py-3 mb-2 rounded-xl bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/5">
