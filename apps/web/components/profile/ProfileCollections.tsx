  ...
  return (
    <div className="bg-[#111228] border border-white/5 rounded-2xl p-5 flex flex-col h-full">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {collections.map((col) => (
          <div key={col.id} className="flex flex-col group cursor-pointer">
            <div className={`relative aspect-[4/5] rounded-xl bg-gradient-to-br ${col.gradient} p-4 flex flex-col items-center justify-center mb-2 overflow-hidden shadow-lg group-hover:shadow-xl group-hover:-translate-y-1 transition-all ${col.shadow}`}>
            ...
            <h4 className="text-sm font-bold text-white text-center">{col.title}</h4>
        ...
        <div className="flex flex-col group cursor-pointer">
          <div className="relative aspect-[4/5] rounded-xl border-2 border-dashed border-white/10 hover:border-[#6366F1]/50 bg-[#0A0B1A]/50 flex flex-col items-center justify-center mb-2 transition-all">
            <div className="w-10 h-10 rounded-full bg-[#111228] border border-white/5 flex items-center justify-center mb-2 group-hover:bg-[#6366F1] group-hover:border-[#6366F1] transition-all">
              <Plus className="w-5 h-5 text-gray-500 group-hover:text-white" />
            </div>
          </div>
          <h4 className="text-sm font-bold text-gray-400 text-center group-hover:text-white transition-colors">Create New</h4>
