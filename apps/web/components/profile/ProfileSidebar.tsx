    ...
    <div className="w-64 shrink-0 flex flex-col gap-6">
      ...
      <div className="flex flex-col items-center">
        <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-transparent bg-gradient-to-tr from-[#6366F1] to-purple-500 p-0.5 relative mb-4">
          <div className="w-full h-full bg-[#111228] rounded-full overflow-hidden">
          ...
          <div className="absolute bottom-1 right-1 w-4 h-4 bg-green-500 border-2 border-[#0A0B1A] rounded-full"></div>
        </div>
        
        <h2 className="text-xl font-bold font-outfit text-white mb-1">GameMaster</h2>
        <span className="px-3 py-1 bg-[#6366F1]/20 text-[#6366F1] text-xs font-bold rounded-full mb-4">Level 28</span>
        
        <div className="w-full flex justify-between text-xs text-gray-400 font-medium mb-2">
          <span>XP</span>
          <span className="text-gray-300">12,450 / 20,000</span>
        </div>
      ...
      {/* Navigation Menu */}
      <nav className="flex flex-col gap-1 w-full border-t border-b border-white/5 py-4">
      ...
      <nav className="flex flex-col gap-1 w-full">
        <button className="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-400 hover:text-white hover:bg-white/5 transition-all text-left">
          <Settings size={18} />
      ...
      <div className="mt-4 bg-[#111228] border border-white/5 rounded-2xl p-4 flex flex-col items-center relative overflow-hidden group">
        ...
        <h4 className="text-sm font-bold text-white mb-1 w-full">Next Level Reward</h4>
        <p className="text-xs text-gray-400 mb-4 w-full">Reach Level 30</p>
        ...
        <div className="w-full h-1.5 bg-[#0A0B1A] rounded-full overflow-hidden mt-2 relative">
          <div className="h-full bg-gradient-to-r from-purple-500 to-pink-500 rounded-full" style={{ width: '62%' }}></div>
        </div>
        <div className="w-full text-center text-xs text-gray-400 mt-2">12,450 / 20,000 XP</div>
      </div>
    </div>
  );
}
